...
public class BadgeRoomTest extends ActivityInstrumentationTestCase2 {
    ...
    private com.peacecorps.malaria.activities.BadgeRoom mActivity;
    ...
    public BadgeRoomTest() {
        super("com.peacecorps.malaria.code.activities", com.peacecorps.malaria.activities.BadgeRoom.class);
    }

    public void setUp() throws Exception {
        super.setUp();
        setActivityInitialTouchMode(false);
        mActivity = (com.peacecorps.malaria.activities.BadgeRoom) getActivity();
