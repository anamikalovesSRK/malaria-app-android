...
public class MedicineStoreTest extends ActivityInstrumentationTestCase2 {
    ...
    private com.peacecorps.malaria.activities.MedicineStore mActivity;
    ...
    public MedicineStoreTest() {
        super("com.peacecorps.malaria.code.activities", com.peacecorps.malaria.activities.MedicineStore.class);
    }

    public void setUp() throws Exception {
        super.setUp();
        setActivityInitialTouchMode(false);
        mActivity= (com.peacecorps.malaria.activities.MedicineStore)getActivity();
