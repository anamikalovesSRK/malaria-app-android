...
public class MythFactGameTest extends ActivityInstrumentationTestCase2 {
    ...
    private com.peacecorps.malaria.activities.MythFactGame mActivity;
    private TextView tvQuestion;
    private TextView tvUserCoins;
    private TextView trash;
    private TextView chest;
    public MythFactGameTest() {
        super(com.peacecorps.malaria.activities.MythFactGame.class);
    }

    public void setUp() throws Exception {
        super.setUp();
        setActivityInitialTouchMode(false);
        mActivity=(com.peacecorps.malaria.activities.MythFactGame)getActivity();
