...
public class NewHomeActivityTest extends ActivityInstrumentationTestCase2 {
    ...
    private com.peacecorps.malaria.activities.NewHomeActivity mActivity;
    ...
    public NewHomeActivityTest() {
        super("com.peacecorps.malaria.code.activities", com.peacecorps.malaria.activities.NewHomeActivity.class);
    }
    ...
    protected void setUp() throws Exception {
        ...
        mActivity = (com.peacecorps.malaria.activities.NewHomeActivity) getActivity();
