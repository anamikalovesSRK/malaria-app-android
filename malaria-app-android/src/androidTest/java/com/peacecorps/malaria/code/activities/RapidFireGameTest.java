...
public class RapidFireGameTest extends ActivityInstrumentationTestCase2 {
    ...
    private com.peacecorps.malaria.activities.RapidFireGame mActivity;
    private Button opt1;
    private Button opt2;
    private Button opt3;
    ...
    public RapidFireGameTest() {
        super(com.peacecorps.malaria.activities.RapidFireGame.class);
    }

    public void setUp() throws Exception {
        super.setUp();
        setActivityInitialTouchMode(false);
        mActivity=(com.peacecorps.malaria.activities.RapidFireGame)getActivity();
