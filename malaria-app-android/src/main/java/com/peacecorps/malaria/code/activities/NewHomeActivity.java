...
public class NewHomeActivity extends Activity{
    ...
    private View.OnClickListener medicineStoreOnClickListener() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(NewHomeActivity.this, com.peacecorps.malaria.activities.MedicineStore.class));
            }
        };
    }
    ...
    private View.OnClickListener badgeScreenOnClickListener() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(NewHomeActivity.this, com.peacecorps.malaria.activities.BadgeRoom.class));
            }
        };
    }
    ...
    private View.OnClickListener mythFactGameOnClickListener() {
        return new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else startActivity(new Intent(NewHomeActivity.this, com.peacecorps.malaria.activities.MythFactGame.class));
            }
        };
    }
    ...
    private View.OnClickListener rapidFireButtonOnClickListener() {
        return new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else startActivity(new Intent(NewHomeActivity.this, com.peacecorps.malaria.activities.RapidFireGame.class));
            }
        };
    }
    ...
    public void showHelpDialog(final int gameID) {
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.commit();
                if (gameID == getResources().getInteger(R.integer.RapidFireGame))
                    startActivity(new Intent(NewHomeActivity.this, com.peacecorps.malaria.activities.RapidFireGame.class));
                else if (gameID == getResources().getInteger(R.integer.MythFactGame))
                    startActivity(new Intent(NewHomeActivity.this, com.peacecorps.malaria.activities.MythFactGame.class));
                helpDialog.dismiss();
            }
        });
        helpDialog.show();
