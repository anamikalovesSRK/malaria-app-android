...
import com.peacecorps.malaria.code.widget.TripAppWidgetProvider;
...
public class TripIndicatorFragmentActivity extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mLocationPicked=intent.getStringExtra(com.peacecorps.malaria.activities.TripIndicatorDialogActivity.LOCATION_TAG);
    ...
    public void addListeners(){
        ...
        loc_history.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplication(), com.peacecorps.malaria.activities.TripIndicatorDialogActivity.class);
