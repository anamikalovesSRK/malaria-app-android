...
public class DrugArrayAdapter extends ArrayAdapter<String>{
    ...
    private  UserMedicineSettingPresenter presenter;
    ...
    public View getView(int position, View view, @NonNull ViewGroup parent) {
        ...
        View rowView= context.getLayoutInflater().inflate(R.layout.trip_drug_item, parent, true);
    ...
    public View getDropDownView(int position, View View, @NonNull ViewGroup parent) {
        //inflating the customized view
        View rowView= context.getLayoutInflater().inflate(R.layout.trip_drug_info, parent, true);

        TextView txtTitle = rowView.findViewById(R.id.nameDrug);
