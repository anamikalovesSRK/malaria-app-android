...
import static com.peacecorps.malaria.ui.user_medicine_setting.UserMedicineSettingContract.*;

public class UserMedicineSettingPresenter<V extends View> extends BasePresenter<V> implements Presenter<V> {

    UserMedicineSettingPresenter(AppDataManager manager, Context context) {
